...
bool Transcloud::LaserscanToPcl(const sensor_msgs::LaserScan::ConstPtr &scan,
                                CloudData &pclcloud) {
  laser_geometry::LaserProjection *projector_ =
      new laser_geometry::LaserProjection();
...
bool Transcloud::LasersacanToPoint2(
...
bool Transcloud::PclToPoint2(CloudData::CLOUD_PTR &pclcloud_ptr,
                             sensor_msgs::PointCloud2Ptr &cloud) {
  pcl::toROSMsg(*pclcloud_ptr, *cloud);
  return true;
}

bool Transcloud::Point2ToPcl(const sensor_msgs::PointCloud2 &cloud,
                             CloudData &pclcloud) {
  pclcloud.time = cloud.header.stamp.toSec();
  pcl::fromROSMsg(cloud, *(pclcloud.cloud_ptr));
...
bool Transcloud::Point2ToPcl(
    const sensor_msgs::PointCloud2::ConstPtr &cloud_ptr, CloudData &pclcloud) {
